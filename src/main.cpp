...
uint256 hashGenesisBlock("0x0a9135141162c2b11d24bf8288c290bf5747d7cccafbabc3a61b900025ed4037");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Baecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Baecoin Signed Message:\n";
...
{
    // Baecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Baecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Baecoin: 3.5 days
static const int64 nTargetSpacing = 150; // Baecoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Baecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Baecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Baecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd31b5283a9d59e9ed74fdc144d275a788fd639fba50bd447c579246ce7623347");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("48bac804d79148729c9500d371b8a0f95257326d9583c40b4d1ef7558a1addcecdb18e7f435cd8d77802a07f53717469c071601788e6a4650cbbe372349b90062f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1430929545;
        block.nBits    = 504365644;
        block.nNonce   = 336062872;

        if (fTestNet)
        {
            block.nTime    = 1430929545;
            block.nNonce   = 2421692975;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe3e476bea7a1bf102048fea1540cfeb5fc79d42870a05900fd818dd9ea932d15"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Baecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BaecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BaecoinMiner : ProcessBlock, block not accepted");
    }
